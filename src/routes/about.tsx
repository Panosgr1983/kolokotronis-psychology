  ...
  return (
    <PageShell>
      <PageHero
        ...
        subtitle="Ψυχολόγος, σύμβουλος ψυχικής υγείας και συνδυαστικός θεραπευτής."
      />
      ...
      <section className="container-page py-16 md:py-20 grid lg:grid-cols-5 gap-12">
        ...
        <div className="lg:col-span-3 space-y-5 text-foreground/85 leading-relaxed">
          <p>
            Από μικρή ηλικία με γοήτευε ο τρόπος που λειτουργεί ο ανθρώπινος νους — τα συναισθήματα, οι σχέσεις, η αναζήτηση του νοήματος. Αυτή η περιέργεια με οδήγησε στις σπουδές της Ψυχολογίας και αργότερα στη συστηματική μελέτη συμπληρωματικών προσεγγίσεων.
          </p>
          <p>
